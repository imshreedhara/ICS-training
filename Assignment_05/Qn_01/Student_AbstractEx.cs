...
namespace Qn_01
{
    abstract class Student_AbstractEx
    {
        public string Name;
    ...
    class Undergraduate : Student_AbstractEx
    {
    ...
    class Graduate : Student_AbstractEx
    {
        public override bool Ispassed(float Grade)
        {
            if (Grade > 80.0f)
    ...
    class Program
    {
        ...
        {
            Student_AbstractEx obj1 = new Undergraduate();
            ...
            Student_AbstractEx obj2 = new Graduate();
